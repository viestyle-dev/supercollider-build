...
WORKDIR /src
# ビルドするタグ（例: Version-3.13.0）。CI からは --build-arg SC_VERSION=... で上書きされる
...
# ---- artifact stage (armv7): tarball 抽出専用。docker buildx build --target artifact -o type=local,dest=./out ----
